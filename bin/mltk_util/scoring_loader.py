...
class ScoringLoadingStrategy(object, metaclass=abc.ABCMeta):
        ...
        return dict(
            (
                scoring['name'],
                {
                    ...
                    'subpackage': get_content_item_name(scoring, 'subpackage'),
                    'module': get_content_item_name(scoring, 'module'),
                    'class': get_content_item_name(scoring, 'class'),
                },
            )
            for scoring in content['entry']
            if scoring['name'] != default_stanza
        )
        ...
        return dict(
            (
                scoring,
                {
                    ...
                    'subpackage': scorings[scoring]['args']['subpackage'],
