...
import input_module_strava_webhook as input_module
...
'''
    ...
    Add your modular input logic to file input_module_strava_webhook.py
'''
class ModInputstrava_webhook(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputstrava_webhook, self).__init__("ta_strava_for_splunk", "strava_webhook", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputstrava_webhook, self).get_scheme()
        ...
        scheme.add_argument(smi.Argument("verify_token", title="Verify Token",
                                         description="Used to configure and verify incoming requests from Strava\'s webhook for authentication.",
                                         required_on_create=True,
                                         required_on_edit=False))
...
if __name__ == "__main__":
    exitcode = ModInputstrava_webhook().run(sys.argv)
    sys.exit(exitcode)
